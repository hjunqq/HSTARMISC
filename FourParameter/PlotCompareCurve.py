...
l1 = plt.plot(xFix,yFix,l1marker,label=u"压缩",linewidth=0.5,  markersize=1)
l2 = plt.plot(xTes,yTes,l2marker,label=u"试验值",linewidth=0.5,  markersize=2)
l3 = plt.plot(xVar,yVar,l3marker,label=u"拉伸",linewidth=0.5,  markersize=2)
plt.xlim(0,4.5)
plt.ylim(0,1.2)
...
plt.legend()
plt.tight_layout()
plt.savefig("FourParameter\\Figs\\VarPara_CompressCompari.pdf")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig("FourParameter\\Figs\\VarPara_StretchCompair.pdf")
plt.close()
