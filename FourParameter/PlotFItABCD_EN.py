...
l2 = plt.plot(x,eA,'o-',label=u"Curve's $A$",linewidth=0.5,  markersize=2)
l1 = plt.plot(x,fA,'k-.',label=u"Fitting $A$",linewidth=0.5)
plt.xlim(0,5)
plt.xlabel(r'$\varepsilon^*/\varepsilon_0$')
plt.legend()
plt.tight_layout()
#plt.show()
plt.savefig("FourParameter\\Figs\\VarPara_A_EN.pdf")
plt.close()

plt.figure(figsize=(4,3.75))
l2 = plt.plot(x,eB,'o-',label=u"Curve's $B$",linewidth=0.5,  markersize=2)
l1 = plt.plot(x,fB,'k-.',label=u"Fitting $B$",linewidth=0.5)
plt.xlim(0,5)
plt.xlabel(r'$\varepsilon^*/\varepsilon_0$')
plt.legend()
plt.tight_layout()
plt.savefig("FourParameter\\Figs\\VarPara_B_EN.pdf")
plt.close()

plt.figure(figsize=(4,3.75))
l2 = plt.plot(x,eC,'o-',label=u"Curve's $C$",linewidth=0.5,  markersize=2)
...
plt.legend()
plt.tight_layout()
plt.savefig("FourParameter\\Figs\\VarPara_C_EN.pdf")
plt.close()

plt.figure(figsize=(4,3.75))
l2 = plt.plot(x,eD,'o-',label=u"Curve's $D$",linewidth=0.5,  markersize=2)
...
plt.legend()
plt.tight_layout()
plt.savefig("FourParameter\\Figs\\VarPara_D_EN.pdf")
plt.close()
exit
