...
l4 = plt.plot(xRes4,yRes4,l4marker,label=r"This paper",linewidth=0.5,  markersize=2)
plt.xlim(0,0.1)
plt.ylim(0,22)
...
plt.tight_layout()
plt.savefig("FourParameter\\Figs\\NooruPlate4a_EN.pdf")
#plt.show()
plt.close()
...
plt.subplots_adjust(left=0.15)
plt.tight_layout()
plt.savefig("FourParameter\\Figs\\NooruPlate4b_EN.pdf")
#plt.show()
plt.close()
