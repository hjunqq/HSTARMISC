...
l1 = plt.plot(xFix,yFix,l1marker,label=u"fixed",linewidth=0.5,  markersize=1)
l2 = plt.plot(xTes,yTes,l2marker,label=u"Guo's",linewidth=0.5,  markersize=2)
l3 = plt.plot(xVar,yVar,l3marker,label=u"variable",linewidth=0.5,  markersize=2)
plt.xlim(0,4.5)
plt.ylim(0,1.2)
...
plt.legend(loc = 1)
plt.tight_layout()
plt.savefig("FourParameter\\Figs\\FixVarComp_UT_EN.pdf")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig("FourParameter\\Figs\\FixVarComp_UC_EN.pdf")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig("FourParameter\\Figs\\FixVarComp_BC_EN.pdf")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig("FourParameter\\Figs\\FixVarComp_TC_EN.pdf")
plt.close()