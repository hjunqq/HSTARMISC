...
l1 = plt.plot(core,timeNo,l1marker,label=r" 1",linewidth=1.0,  markersize=1)
plt.xlim(0,50)
plt.ylim(0,400)
plt.xlabel(r"进程数")
...
plt.tight_layout()
# plt.show()
plt.savefig("Parallel\\HHUHPCTimeFst.pdf")

plt.figure(figsize=(4,3.75))
plt.plot(core,accNo,l1marker,linewidth=1.0,  markersize=1)
plt.xlim(0,50)
plt.ylim(0,70)
plt.xlabel(r"进程数")
plt.ylabel(r"加速比")
plt.tight_layout()
# plt.show()
plt.savefig("Parallel\\HHUHPCAccFst.pdf")
